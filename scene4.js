class Scene4 extends Phaser.Scene {
    ...
    init(data) {
     ...
     preload() {
      ...
      this.load.image('ground3', 'assets/platform2.png');
      ...
      this.load.audio('sfxSword', 'assets/swordSound.wav');
        ...
        create() {
                ...
                this.add.image(400, 300, 'sky3').setScrollFactor(0);

                //SETUP STATIC PLATFORMS
                this.platforms = this.physics.add.staticGroup();
                this.platforms.create(400, 568, 'ground3').setScale(2).refreshBody();
                this.platforms.create(600, 400, 'ground3');
                this.platforms.create(50, 250, 'ground3');
                this.platforms.create(750, 220, 'ground3');
                this.platforms.create(1100, 400, 'ground3');
                this.platforms.create(1300, 250, 'ground3');
                this.platforms.create(1400, 500, 'ground3');
                this.platforms.create(1100, 900, 'ground3');
                this.platforms.create(100, 1175, 'ground3');
                this.platforms.create(700, 700, 'ground3');
                this.platforms.create(500, 1175, 'ground3');
                this.platforms.create(900, 1175, 'ground3');
                this.platforms.create(1300, 1175, 'ground3');
                this.platforms.create(900, 1000, 'ground3');
                this.platforms.create(1400, 1175, 'ground3');
                ...
                function collectStar(player, star) {
                        ...
                        if (score >= 240) {
                                this.music.stop();
                                this.scene.start('EndScene', { score: score }); // Go to Scene2 
                        }
